   nano blog.config.js  # 或使用您喜欢的文本编辑器
...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '唯有如来心中心，余不能及',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '印心宗', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'null', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.yinxin.pp.ua/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '印心精舍, 心中心', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zqdongxw@gmail.com', // 邮箱地址 例如mail@tangly1024.com
 // CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/yrmdmy', // 你的twitter个人主页
  //CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  //CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  //CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  //CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  //CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || '', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@yinxinzong', // Youtube主页
 //CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || '', // 小红书主页
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '踏莎行.无心颂',
      artist: 'suno',
      url: 'https://dlink.host/sharepoint/aHR0cHM6Ly80aDN5NngtbXkuc2hhcmVwb2ludC5jb20vOnU6L2cvcGVyc29uYWwvaGFpd2VpXzRoM3k2eF9vbm1pY3Jvc29mdF9jb20vRWN5NVNRYms3Y2RQZ0xGOVFIcFZ2dG9COEVuZ1h1b1VFRy1QNGsyWC1fbFBYQQ.mp3',
      cover:
